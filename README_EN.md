...
Docker Compose pulls the current versioned Docker Hub images (`maxblack777/angevoice-*:v2.6.614`) by default. If Docker Hub is slow from mainland China, use a Docker mirror proxy:
