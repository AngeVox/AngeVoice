...
def test_runtime_templates_use_versioned_images_and_fnos_uses_verified_profile_routing():
    ...
    for path in image_files:
        ...
        for line in text.splitlines():
            if "image:" in line and "maxblack777/angevoice-" in line:
                assert ":v2.6.616" in line, f"{path.relative_to(ROOT)}: {line}"
    ...
    assert "angevoice-cpu:v2.6.616" in compose and "angevoice-gpu:v2.6.616" in compose and "angevoice-legacy-gpu:v2.6.616" in compose
